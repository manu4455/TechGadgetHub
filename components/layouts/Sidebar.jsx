...
const Sidebar = () => {
  ...
  return (
    <aside className="md:w-1/3 lg:w-1/4 px-4 rounded-2xl border h-auto border-gray-300">
          ...
          <>
            <li>
              ...
              <Link
                ...
                className="block px-3 py-2 text-gray-800 hover:bg-blue-100 hover:text-blue-500 rounded-xl "
              >
